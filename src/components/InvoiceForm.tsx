...
export default function InvoiceForm({
  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-4 sm:p-6 bg-white rounded-lg shadow-sm border border-gray-200">
      ...
      <div className="mb-6 sm:mb-8">
        ...
        <div className="space-y-3 sm:space-y-4">
          {localData.items.map((item, index) => (
            <div
              key={item.id}
              className="grid grid-cols-12 gap-2 sm:gap-3 items-start p-3 sm:p-4 border border-gray-200 rounded-lg bg-gray-50"
            >
              ...
              <div className="col-span-3 md:col-span-2 space-y-2">
                <Label>Amount</Label>
                <div className="h-9 px-3 py-2 text-sm border border-gray-300 rounded-md bg-gray-100 flex items-center">
